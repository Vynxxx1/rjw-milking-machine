...
namespace MilkingMachine
{
    ...
    {
        public static float penisSizeMultiplier = 1;
        ...
        public override void Tick()
        {
            ...
            foreach (Hediff penis in penises)
            {
                ...
                penisThing.stackCount = (int)(pawn.BodySize * penisSizeMultiplier * traitMultiplier * quirkMultiplier * horse * dog * demon);
